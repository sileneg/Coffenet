...
// Consultar los usuarios de la base de datos usando PDO
...
<main>
    <h1 class="page-title">Consultar Usuarios</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editar_usuario.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-edit">Editar</a>
                            <a href="eliminar_usuario.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-delete">Eliminar</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
